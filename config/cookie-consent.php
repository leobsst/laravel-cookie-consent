...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Your Google AdSense publisher ID (e.g., 'pub-XXXXXXXXXXXXXXXX').
    | When set, enables Google Consent Mode v2 for AdSense to prevent
    | Google from displaying a duplicate consent banner alongside this
    | package's banner. Also required to serve the auto-generated ads.txt
    | file. Leave null to disable Google AdSense integration.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Enable Auto-generated Ads.txt File
    |--------------------------------------------------------------------------
    |
    | When enabled and GOOGLE_ADSENSE_CLIENT_ID is configured, the package
    | serves an auto-generated ads.txt file at /ads.txt containing your
    | AdSense publisher ID alongside a comprehensive list of authorized
    | ad network declarations. Set to false to disable this endpoint.
    |
    */

    'ENABLE_AUTOGENERATED_ADS_FILE' => env('ENABLE_AUTOGENERATED_ADS_FILE', true),
];
